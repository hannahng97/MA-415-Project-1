...
* We compare the number of border patrol apprehensions in the years 2010 and 2017 to see if there has been a significant decrease in apprehensions
* We compare different months in each sector
    + Big Bend
    + Del Rio
    + El Centro
    + El Paso
